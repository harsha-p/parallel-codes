...
void mat_mult_block(int tile3, double *__restrict__ A, double *__restrict__ B,
  ...
  for (int i = 0; i < tile3 / 4; i++) {
    for (int j = 0; j < tile3 / 16; j++) {
      __m256d c0_0 = _mm256_loadu_pd(C + ((4 * i + 0) * N) + j * 16 + 0);
      __m256d c0_1 = _mm256_loadu_pd(C + ((4 * i + 0) * N) + j * 16 + 1);
      __m256d c0_2 = _mm256_loadu_pd(C + ((4 * i + 0) * N) + j * 16 + 2);
      __m256d c0_3 = _mm256_loadu_pd(C + ((4 * i + 0) * N) + j * 16 + 3);
      __m256d c1_0 = _mm256_loadu_pd(C + ((4 * i + 1) * N) + j * 16 + 0);
      __m256d c1_1 = _mm256_loadu_pd(C + ((4 * i + 1) * N) + j * 16 + 1);
      __m256d c1_2 = _mm256_loadu_pd(C + ((4 * i + 1) * N) + j * 16 + 2);
      __m256d c1_3 = _mm256_loadu_pd(C + ((4 * i + 1) * N) + j * 16 + 3);
      __m256d c2_0 = _mm256_loadu_pd(C + ((4 * i + 2) * N) + j * 16 + 0);
      __m256d c2_1 = _mm256_loadu_pd(C + ((4 * i + 2) * N) + j * 16 + 1);
      __m256d c2_2 = _mm256_loadu_pd(C + ((4 * i + 2) * N) + j * 16 + 2);
      __m256d c2_3 = _mm256_loadu_pd(C + ((4 * i + 2) * N) + j * 16 + 3);
      __m256d c3_0 = _mm256_loadu_pd(C + ((4 * i + 3) * N) + j * 16 + 0);
      __m256d c3_1 = _mm256_loadu_pd(C + ((4 * i + 3) * N) + j * 16 + 1);
      __m256d c3_2 = _mm256_loadu_pd(C + ((4 * i + 3) * N) + j * 16 + 2);
      __m256d c3_3 = _mm256_loadu_pd(C + ((4 * i + 3) * N) + j * 16 + 3);
      ...
      _mm256_storeu_pd(C + ((4 * i + 0) * N) + j * 16 + 0, c0_0);
      _mm256_storeu_pd(C + ((4 * i + 0) * N) + j * 16 + 1, c0_1);
      _mm256_storeu_pd(C + ((4 * i + 0) * N) + j * 16 + 2, c0_2);
      _mm256_storeu_pd(C + ((4 * i + 0) * N) + j * 16 + 3, c0_3);
      _mm256_storeu_pd(C + ((4 * i + 1) * N) + j * 16 + 0, c1_0);
      _mm256_storeu_pd(C + ((4 * i + 1) * N) + j * 16 + 1, c1_1);
      _mm256_storeu_pd(C + ((4 * i + 1) * N) + j * 16 + 2, c1_2);
      _mm256_storeu_pd(C + ((4 * i + 1) * N) + j * 16 + 3, c1_3);
      _mm256_storeu_pd(C + ((4 * i + 2) * N) + j * 16 + 0, c2_0);
      _mm256_storeu_pd(C + ((4 * i + 2) * N) + j * 16 + 1, c2_1);
      _mm256_storeu_pd(C + ((4 * i + 2) * N) + j * 16 + 2, c2_2);
      _mm256_storeu_pd(C + ((4 * i + 2) * N) + j * 16 + 3, c2_3);
      _mm256_storeu_pd(C + ((4 * i + 3) * N) + j * 16 + 0, c3_0);
      _mm256_storeu_pd(C + ((4 * i + 3) * N) + j * 16 + 1, c3_1);
      _mm256_storeu_pd(C + ((4 * i + 3) * N) + j * 16 + 2, c3_2);
      _mm256_storeu_pd(C + ((4 * i + 3) * N) + j * 16 + 3, c3_3);
    }
  }
}
