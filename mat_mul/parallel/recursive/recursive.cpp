                 ...
                 double **B, double **C)
{
    ...
    int size_p = (pl - pf);
    int size_n = (nl - nf);
    a = (double *)mkl_malloc(size_m * size_p * sizeof(double), 64);
    b = (double *)mkl_malloc(size_p * size_n * sizeof(double), 64);
...
int LIMIT = 262144; /* product size below which matmultleaf is used */
// 32768  <- pow 15
// 65536
// 131072
// 262144
